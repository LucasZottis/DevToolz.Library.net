...
{
    private ICryptAlgorithm Algorithm => CryptFactory.Create( CryptProvider.Aes );
    ...
    public void Encrypt_ThenDecrypt_ShouldReturnOriginalValue()
    {
        ...
        const string original = "Hello, AES!";
    ...
    [Fact]
    public void Encrypt_ThenDecrypt_WithLongKey_ShouldReturnOriginalValue()
    {
        // Arrange
        var algorithm     = Algorithm;
