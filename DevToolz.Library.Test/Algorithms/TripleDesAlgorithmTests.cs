...
public class TripleDesAlgorithmTests
{
    private ICryptAlgorithm Algorithm => CryptFactory.Create( CryptProvider.TripleDES );
    ...
    public void Encrypt_ThenDecrypt_ShouldReturnOriginalValue()
    {
        ...
        const string original = "Hello, TripleDES!";
